...
// Closing line
        ...
        $this->SetXY(120, 168);
        $this->SetFont('Arial', '', 8);
        $this->Cell(0, 0, 'Declaro que realizei todas as visitas listadas acima.', 0, 0, '');
        $this->SetXY(110, 178);

        $this->SetX(90);
        $this->SetFont('Arial', 'B', 7);
        $this->Cell(0, 0, 'Adenis Duarte', 0, 0, '');
        $this->SetX(190);
        $this->Cell(0, 0, 'Mega Empreendimentos', 0, 0, '');
//        $this->Ln(3);
        ...
        $this->SetXY(175, 180);
        $this->Cell(0, 0, "Maceió, " . $horaAgora, 0, 0, 'R');
    }
